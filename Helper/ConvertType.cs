...
namespace Helper
{
    ...
    public static   class ConvertType
    {
           ...
           //To mask number in the format "(999) 999-9999".
           public static string Mask(this object val, bool returnEmptyIfDBNull = false)
           {
               if (val == DBNull.Value)
                   return returnEmptyIfDBNull ? string.Empty : null;
               if (val == null)
               ...
               {
                   return "(" + val.ToString().Substring(0, 3) + ") " + val.ToString().Substring(3, 3) + "-" + val.ToString().Substring(6, 4);
               }
               else
                   return val.ToString();
           }
           ...
           public static string ToRegistrationNumber(this object obj)
           {
               return "TK" + obj.ToStr().PadLeft(8, '0');
           }
           /// <summary>
